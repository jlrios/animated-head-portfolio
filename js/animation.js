...
const bl = document.querySelector("#grid__tl");
// const br = document.querySelector("#grid__tl");
...
function playAnimation(animation, reverseAnimation) {
    ...
    if (lastReverseAnimation !== "") {
        console.log("lra 1 -> " + lastReverseAnimation)
        ...
        console.log("lra 2 -> " + lastReverseAnimation)
        heroImage.classList.add(animation);
        lastReverseAnimation = reverseAnimation;
    }
}
...
//         tlBtn.innerHTML = "&uarr;<br>Contact";
//         handleWindowResize();
